...
ActiveRecord::Schema[7.2].define(version: 2024_11_12_051747) do
  ...
  create_table "reading_entries", force: :cascade do |t|
    ...
    t.index ["literary_work_id", "reader_type", "reader_id"], name: "index_reading_entries_uniqueness", unique: true
